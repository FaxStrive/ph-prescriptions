...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-veil-x" style={{ position: "absolute", inset: 0 }} />
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: "0 2px 10px rgba(30,15,60,0.12)",
                }}
              >
                <Image src={d.photo} alt={d.name} fill sizes="72px" style={{ objectFit: "cover" }} />
              </div>
              <div
                style={{
                  fontFamily: "var(--font-display)",
...
const MARQUEE_ROW_A = [
  ...
  { src: "/images/installations/under-sink-system-closeup.jpg", alt: "Under-sink multi-stage filtration system installed" },
  { src: "/images/lifestyle2/idw-child-drinking-1.jpg", alt: "Child drinking a glass of clean filtered water" },
  { src: "/images/installations/premium-brass-fixtures.jpg", alt: "Premium brass kitchen fixtures with filtered water tap" },
  { src: "/images/lifestyle2/idw-tap-glass-1.jpg", alt: "Glass being filled at a filtered kitchen tap" },
  { src: "/images/installations/bathroom-install-scene.jpg", alt: "Bathroom filtration installation in progress" },
  { src: "/images/lifestyle2/idw-happy-family-1.jpg", alt: "Family raising glasses of clean water" },
  { src: "/images/installations/under-cabinet-system.jpg", alt: "Compact under-cabinet drinking water system" },
  { src: "/images/lifestyle2/aw-glass-fill.jpg", alt: "Clear glass filling with purified water" },
];

const MARQUEE_ROW_B = [
  { src: "/images/lifestyle2/idw-family-kitchen-1.jpg", alt: "Family preparing food with clean water in the kitchen" },
  { src: "/images/installations/technician-focused-install.jpg", alt: "Technician focused on a system installation" },
  { src: "/images/lifestyle2/idw-person-drinking-2.jpg", alt: "Person drinking a glass of fresh water" },
  { src: "/images/installations/kitchen-install-complete.jpg", alt: "Completed kitchen installation with dedicated faucet" },
  { src: "/images/lifestyle2/idw-people-drinking-3.jpg", alt: "Friends sharing glasses of filtered water outdoors" },
  { src: "/images/installations/install-with-dog.jpg", alt: "Home install visit with the family dog watching" },
  { src: "/images/lifestyle2/idw-tap-filling-1.jpg", alt: "Filtered water filling a glass at the tap" },
  { src: "/images/installations/bathroom-install-detail.jpg", alt: "Detail of a bathroom water system install" },
  { src: "/images/lifestyle2/aw-woman-drinking.jpg", alt: "Woman drinking clean water in the morning light" },
  { src: "/images/installations/under-sink-system-alt-view.jpg", alt: "Under-sink reverse osmosis system, alternate view" },
];

function InstallMarquee() {
  return (
    <section style={{ background: "var(--color-surface)", padding: "clamp(4rem, 7vw, 6rem) 0", overflow: "hidden" }}>
      <div className="max-content" style={{ textAlign: "center", marginBottom: "2.75rem" }}>
        <span className="eyebrow" style={{ color: "var(--color-navy)" }}>In the Field</span>
        <h2
          style={{
            marginTop: "1rem",
            fontFamily: "var(--font-display)",
        ...
        >
          Installed across <span className="italic-accent" style={{ color: "var(--color-teal)" }}>all fifty states.</span>
        </h2>
        <p style={{ marginTop: "0.875rem", color: "var(--color-ink-soft)", fontSize: "1rem", lineHeight: 1.7, maxWidth: "52ch", marginLeft: "auto", marginRight: "auto" }}>
          Real systems, real kitchens, real families. Every install backed by our warranty program.
        </p>
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        {[{ row: MARQUEE_ROW_A, reverse: false }, { row: MARQUEE_ROW_B, reverse: true }].map(({ row, reverse }, i) => (
              ...
              {[...row, ...row].map((img, j) => (
                <div
                  ...
                  style={{
                    ...
                    aspectRatio: j % 3 === 1 ? "4 / 3" : j % 3 === 2 ? "1 / 1" : "3 / 2",
                    flexShrink: 0,
                    overflow: "hidden",
                    background: "#fff",
                  }}
  ...
  return (
    ...
    >
      {!reduce && (
        ...
        >
          <source src="/video/water-underwater.mp4" type="video/mp4" />
        </video>
      )}
      <div
        aria-hidden
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(to bottom, rgba(59,36,102,0.75) 0%, rgba(59,36,102,0.45) 50%, rgba(59,36,102,0.8) 100%)",
        }}
      />
      <div className="max-content" style={{ position: "relative", maxWidth: "760px" }}>
        <span
          className="eyebrow"
