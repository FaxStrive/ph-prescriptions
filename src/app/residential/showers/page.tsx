  ...
  return (<>
    <section style={{ background: "var(--color-navy)", color: "#fff", padding: "5rem 0 4rem" }}>
      <div className="container" style={{ maxWidth: "700px" }}>
        ...
        <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.82)", lineHeight: 1.75 }}>The Aquapellis shower system delivers molecular hydrogen transdermally with every shower. Every shower becomes a therapeutic H2 treatment session. No electricity, compatible with existing plumbing.</p>
      </div>
    </section>
